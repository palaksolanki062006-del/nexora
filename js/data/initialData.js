...
export const OPPORTUNITIES_DATABASE = [
  ...
  },
  {
    ...
    expectedValue: "Cash prizes, direct recruitment interviews from sponsoring tech giants, and ministerial felicitation.",
    skillMatchPercent: 85,
...
// Helper to expand opportunities to 100 realistic records across 12 categories
export function generateFullOpportunitiesDatabase() {
  ...
  const orgs = [
    ...
    { name: "Observer Research Foundation (ORF)", cat: "Internships", loc: "New Delhi", remote: true },
    { name: "Amazon AWS Academy", cat: "Certifications", loc: "Online", remote: true },
    { name: "Teach For India", cat: "Volunteering", loc: "Pune / Delhi", remote: false },
    { name: "Y Combinator Startup School", cat: "Entrepreneurship", loc: "Online", remote: true },
    { name: "Indian Institute of Management Ahmedabad (IIMA)", cat: "Research", loc: "Ahmedabad", remote: false },
    { name: "HDFC Badhte Kadam Scholarship", cat: "Scholarships", loc: "Pan-India", remote: true },
    { name: "IIT Bombay E-Cell Eureka!", cat: "Competitions", loc: "Mumbai", remote: true },
    { name: "United Nations Development Programme (UNDP)", cat: "Fellowships", loc: "New Delhi", remote: true },
    { name: "Bain & Company", cat: "Internships", loc: "Gurugram", remote: false },
    { name: "DeepMind AI Alignment Grant", cat: "Research", loc: "Online", remote: true }
  ];
  ...
  for (let i = 0; i < 90; i++) {
    ...
    const month = (i % 3) + 9; // Sept, Oct, Nov
    const day = (i * 3 % 27) + 1;
...
export const INITIAL_APPLICATIONS = [
  {
    ...
    stage: "Considering", // Saved, Considering, Applied, Assessment, Interview, Selected, Rejected, Withdrawn
    deadline: "2026-08-28",
    appliedDate: null,
